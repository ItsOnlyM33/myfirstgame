...
player = createSprite(displayWidth-1150, displayHeight/2, 50, 50);
 player.addImage(shooterImg)
   player.scale = 0.3
   player.debug = true
   player.setCollider("rectangle",0,0,300,300)
  // player.collide(boundry)



boundry = createSprite(0,0,displayWidth,10)
boundry2 = createSprite(0,displayHeight-150,displayWidth,10)
...
if(player.isTouching(boundry)){
  player.y = player.y+30
}

if(player.isTouching(boundry2)){
  player.y = player.y-30
}
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(900,1500),random(100,500),40,40)
